...
goog.addDependency('../../../demo/common/asset.js', ['ShakaDemoAssetInfo'], ['shakaDemo.MessageIds']);
goog.addDependency('../../../demo/common/message_ids.js', ['shakaDemo.MessageIds'], []);
...
goog.addDependency('../../../lib/ads/ad_manager.js', ['shaka.ads.AdManager'], ['shaka.Player', 'shaka.ads.ClientSideAdManager', 'shaka.util.FakeEventTarget']);
goog.addDependency('../../../lib/ads/client_side_ad.js', ['shaka.ads.ClientSideAd'], []);
...
goog.addDependency('../../../lib/cast/cast_utils.js', ['shaka.cast.CastUtils'], ['shaka.media.TimeRangesUtils', 'shaka.util.FakeEvent']);
goog.addDependency('../../../lib/dash/content_protection.js', ['shaka.dash.ContentProtection'], ['goog.asserts', 'shaka.log', 'shaka.util.BufferUtils', 'shaka.util.Error', 'shaka.util.ManifestParserUtils', 'shaka.util.Pssh', 'shaka.util.Uint8ArrayUtils', 'shaka.util.XmlUtils']);
goog.addDependency('../../../lib/dash/dash_parser.js', ['shaka.dash.DashParser'], ['goog.asserts', 'shaka.abr.Ewma', 'shaka.dash.ContentProtection', 'shaka.dash.MpdUtils', 'shaka.dash.SegmentBase', 'shaka.dash.SegmentList', 'shaka.dash.SegmentTemplate', 'shaka.log', 'shaka.media.DrmEngine', 'shaka.media.ManifestParser', 'shaka.media.PresentationTimeline', 'shaka.media.SegmentIndex', 'shaka.net.NetworkingEngine', 'shaka.text.TextEngine', 'shaka.util.Error', 'shaka.util.Functional', 'shaka.util.Iterables', 'shaka.util.LanguageUtils', 'shaka.util.ManifestParserUtils', 'shaka.util.MimeUtils', 'shaka.util.Networking', 'shaka.util.OperationManager', 'shaka.util.StringUtils', 'shaka.util.XmlUtils']);
goog.addDependency('../../../lib/dash/mpd_utils.js', ['shaka.dash.MpdUtils'], ['goog.asserts', 'shaka.log', 'shaka.net.NetworkingEngine', 'shaka.util.AbortableOperation', 'shaka.util.Error', 'shaka.util.Functional', 'shaka.util.Iterables', 'shaka.util.ManifestParserUtils', 'shaka.util.XmlUtils']);
...
goog.addDependency('../../../lib/dash/segment_list.js', ['shaka.dash.SegmentList'], ['goog.asserts', 'shaka.dash.MpdUtils', 'shaka.dash.SegmentBase', 'shaka.log', 'shaka.media.InitSegmentReference', 'shaka.media.SegmentIndex', 'shaka.media.SegmentReference', 'shaka.util.Error', 'shaka.util.Functional', 'shaka.util.Iterables', 'shaka.util.ManifestParserUtils', 'shaka.util.XmlUtils']);
goog.addDependency('../../../lib/dash/segment_template.js', ['shaka.dash.SegmentTemplate'], ['goog.asserts', 'shaka.dash.MpdUtils', 'shaka.dash.SegmentBase', 'shaka.log', 'shaka.media.InitSegmentReference', 'shaka.media.SegmentIndex', 'shaka.media.SegmentReference', 'shaka.util.Error', 'shaka.util.Iterables', 'shaka.util.ManifestParserUtils', 'shaka.util.ObjectUtils']);
goog.addDependency('../../../lib/debug/asserts.js', ['goog.asserts'], []);
goog.addDependency('../../../lib/debug/log.js', ['shaka.log'], ['goog.asserts']);
...
goog.addDependency('../../../lib/hls/hls_parser.js', ['shaka.hls.HlsParser'], ['goog.Uri', 'goog.asserts', 'shaka.Deprecate', 'shaka.hls.ManifestTextParser', 'shaka.hls.Playlist', 'shaka.hls.PlaylistType', 'shaka.hls.Tag', 'shaka.hls.Utils', 'shaka.log', 'shaka.media.DrmEngine', 'shaka.media.InitSegmentReference', 'shaka.media.ManifestParser', 'shaka.media.PresentationTimeline', 'shaka.media.SegmentIndex', 'shaka.media.SegmentReference', 'shaka.net.DataUriPlugin', 'shaka.net.NetworkingEngine', 'shaka.util.ArrayUtils', 'shaka.util.DataViewReader', 'shaka.util.Error', 'shaka.util.Functional', 'shaka.util.Iterables', 'shaka.util.LanguageUtils', 'shaka.util.ManifestParserUtils', 'shaka.util.MimeUtils', 'shaka.util.Mp4Parser', 'shaka.util.Networking', 'shaka.util.OperationManager', 'shaka.util.Timer']);
...
goog.addDependency('../../../lib/media/adaptation_set.js', ['shaka.media.AdaptationSet'], ['goog.asserts', 'shaka.util.Iterables', 'shaka.util.MimeUtils']);
...
goog.addDependency('../../../lib/media/closed_caption_parser.js', ['shaka.media.IClosedCaptionParser', 'shaka.media.MuxJSClosedCaptionParser', 'shaka.media.NoopCaptionParser'], ['shaka.util.BufferUtils']);
goog.addDependency('../../../lib/media/drm_engine.js', ['shaka.media.DrmEngine'], ['goog.asserts', 'shaka.log', 'shaka.net.NetworkingEngine', 'shaka.util.BufferUtils', 'shaka.util.Destroyer', 'shaka.util.Error', 'shaka.util.EventManager', 'shaka.util.FairPlayUtils', 'shaka.util.FakeEvent', 'shaka.util.IDestroyable', 'shaka.util.Iterables', 'shaka.util.Lazy', 'shaka.util.MapUtils', 'shaka.util.MimeUtils', 'shaka.util.Platform', 'shaka.util.PublicPromise', 'shaka.util.StringUtils', 'shaka.util.Timer', 'shaka.util.Uint8ArrayUtils']);
...
goog.addDependency('../../../lib/media/media_source_engine.js', ['shaka.media.MediaSourceEngine'], ['goog.asserts', 'shaka.log', 'shaka.media.IClosedCaptionParser', 'shaka.media.TimeRangesUtils', 'shaka.media.Transmuxer', 'shaka.text.TextEngine', 'shaka.util.Destroyer', 'shaka.util.Error', 'shaka.util.EventManager', 'shaka.util.Functional', 'shaka.util.IDestroyable', 'shaka.util.ManifestParserUtils', 'shaka.util.MimeUtils', 'shaka.util.Platform', 'shaka.util.PublicPromise']);
goog.addDependency('../../../lib/media/mp4_segment_index_parser.js', ['shaka.media.Mp4SegmentIndexParser'], ['goog.asserts', 'shaka.log', 'shaka.media.InitSegmentReference', 'shaka.media.SegmentReference', 'shaka.util.Error', 'shaka.util.Iterables', 'shaka.util.Mp4Parser']);
...
goog.addDependency('../../../lib/media/segment_index.js', ['shaka.media.SegmentIndex'], ['goog.asserts', 'shaka.log', 'shaka.media.SegmentReference', 'shaka.util.IDestroyable', 'shaka.util.Timer']);
...
goog.addDependency('../../../lib/media/stall_detector.js', ['shaka.media.StallDetector', 'shaka.media.StallDetector.Implementation', 'shaka.media.StallDetector.MediaElementImplementation'], ['shaka.media.TimeRangesUtils']);
goog.addDependency('../../../lib/media/streaming_engine.js', ['shaka.media.StreamingEngine'], ['goog.asserts', 'shaka.log', 'shaka.media.MediaSourceEngine', 'shaka.net.Backoff', 'shaka.net.NetworkingEngine', 'shaka.util.DelayedTick', 'shaka.util.Destroyer', 'shaka.util.Error', 'shaka.util.FakeEvent', 'shaka.util.IDestroyable', 'shaka.util.Iterables', 'shaka.util.ManifestParserUtils', 'shaka.util.MimeUtils', 'shaka.util.Mp4Parser', 'shaka.util.Networking', 'shaka.util.Periods']);
goog.addDependency('../../../lib/media/time_ranges_utils.js', ['shaka.media.TimeRangesUtils'], ['shaka.util.Iterables', 'shaka.util.Platform']);
goog.addDependency('../../../lib/media/transmuxer.js', ['shaka.media.Transmuxer'], ['goog.asserts', 'shaka.util.BufferUtils', 'shaka.util.Error', 'shaka.util.IDestroyable', 'shaka.util.ManifestParserUtils', 'shaka.util.PublicPromise', 'shaka.util.Uint8ArrayUtils']);
...
goog.addDependency('../../../lib/media/webm_segment_index_parser.js', ['shaka.media.WebmSegmentIndexParser'], ['goog.asserts', 'shaka.log', 'shaka.media.InitSegmentReference', 'shaka.media.SegmentReference', 'shaka.util.EbmlElement', 'shaka.util.EbmlParser', 'shaka.util.Error']);
...
goog.addDependency('../../../lib/net/networking_engine.js', ['shaka.net.NetworkingEngine', 'shaka.net.NetworkingEngine.PendingRequest'], ['goog.Uri', 'goog.asserts', 'shaka.net.Backoff', 'shaka.util.AbortableOperation', 'shaka.util.BufferUtils', 'shaka.util.Error', 'shaka.util.FakeEvent', 'shaka.util.FakeEventTarget', 'shaka.util.IDestroyable', 'shaka.util.ObjectUtils', 'shaka.util.OperationManager']);
goog.addDependency('../../../lib/offline/download_manager.js', ['shaka.offline.DownloadManager'], ['shaka.net.NetworkingEngine', 'shaka.offline.DownloadProgressEstimator', 'shaka.util.BufferUtils', 'shaka.util.Destroyer', 'shaka.util.Error', 'shaka.util.IDestroyable', 'shaka.util.Pssh']);
goog.addDependency('../../../lib/offline/download_progress_estimator.js', ['shaka.offline.DownloadProgressEstimator'], []);
goog.addDependency('../../../lib/offline/indexeddb/base_storage_cell.js', ['shaka.offline.indexeddb.BaseStorageCell'], ['shaka.offline.indexeddb.DBConnection', 'shaka.util.Error']);
...
goog.addDependency('../../../lib/offline/indexeddb/v1_storage_cell.js', ['shaka.offline.indexeddb.V1StorageCell'], ['goog.asserts', 'shaka.log', 'shaka.offline.indexeddb.BaseStorageCell', 'shaka.util.Error', 'shaka.util.ManifestParserUtils', 'shaka.util.PublicPromise']);
goog.addDependency('../../../lib/offline/indexeddb/v2_storage_cell.js', ['shaka.offline.indexeddb.V2StorageCell'], ['shaka.offline.indexeddb.BaseStorageCell']);
...
goog.addDependency('../../../lib/player.js', ['shaka.Player'], ['goog.asserts', 'shaka.Deprecate', 'shaka.log', 'shaka.media.ActiveStreamMap', 'shaka.media.AdaptationSetCriteria', 'shaka.media.BufferingObserver', 'shaka.media.DrmEngine', 'shaka.media.ManifestParser', 'shaka.media.MediaSourceEngine', 'shaka.media.MuxJSClosedCaptionParser', 'shaka.media.NoopCaptionParser', 'shaka.media.PeriodObserver', 'shaka.media.PlayRateController', 'shaka.media.Playhead', 'shaka.media.PlayheadObserverManager', 'shaka.media.PreferenceBasedCriteria', 'shaka.media.RegionObserver', 'shaka.media.RegionTimeline', 'shaka.media.SegmentIndex', 'shaka.media.StreamingEngine', 'shaka.net.NetworkingEngine', 'shaka.routing.Walker', 'shaka.text.SimpleTextDisplayer', 'shaka.util.ArrayUtils', 'shaka.util.Error', 'shaka.util.EventManager', 'shaka.util.FakeEvent', 'shaka.util.FakeEventTarget', 'shaka.util.IDestroyable', 'shaka.util.LanguageUtils', 'shaka.util.ManifestParserUtils', 'shaka.util.MimeUtils', 'shaka.util.MultiMap', 'shaka.util.Periods', 'shaka.util.Platform', 'shaka.util.PlayerConfiguration', 'shaka.util.Stats', 'shaka.util.StreamUtils', 'shaka.util.Timer']);
goog.addDependency('../../../lib/polyfill/all.js', ['shaka.polyfill'], ['shaka.log', 'shaka.util.Iterables']);
goog.addDependency('../../../lib/polyfill/encryption_scheme.js', ['shaka.polyfill.EncryptionScheme'], ['shaka.polyfill']);
goog.addDependency('../../../lib/polyfill/fullscreen.js', ['shaka.polyfill.Fullscreen'], ['shaka.polyfill']);
goog.addDependency('../../../lib/polyfill/indexed_db.js', ['shaka.polyfill.IndexedDB'], ['goog.asserts', 'shaka.log', 'shaka.polyfill']);
goog.addDependency('../../../lib/polyfill/input_event.js', ['shaka.polyfill.InputEvent'], ['shaka.log', 'shaka.polyfill']);
goog.addDependency('../../../lib/polyfill/languages.js', ['shaka.polyfill.Languages'], ['shaka.polyfill']);
goog.addDependency('../../../lib/polyfill/mathround.js', ['shaka.polyfill.MathRound'], ['shaka.log', 'shaka.polyfill']);
goog.addDependency('../../../lib/polyfill/mediasource.js', ['shaka.polyfill.MediaSource'], ['shaka.log', 'shaka.polyfill', 'shaka.util.MimeUtils', 'shaka.util.Platform']);
goog.addDependency('../../../lib/polyfill/patchedmediakeys_apple.js', ['shaka.polyfill.PatchedMediaKeysApple'], ['goog.asserts', 'shaka.log', 'shaka.media.DrmEngine', 'shaka.polyfill', 'shaka.util.BufferUtils', 'shaka.util.EventManager', 'shaka.util.FakeEvent', 'shaka.util.FakeEventTarget', 'shaka.util.PublicPromise']);
goog.addDependency('../../../lib/polyfill/patchedmediakeys_ms.js', ['shaka.polyfill.PatchedMediaKeysMs'], ['goog.asserts', 'shaka.log', 'shaka.media.DrmEngine', 'shaka.polyfill', 'shaka.util.BufferUtils', 'shaka.util.EventManager', 'shaka.util.FakeEvent', 'shaka.util.FakeEventTarget', 'shaka.util.Pssh', 'shaka.util.PublicPromise']);
goog.addDependency('../../../lib/polyfill/patchedmediakeys_nop.js', ['shaka.polyfill.PatchedMediaKeysNop'], ['goog.asserts', 'shaka.log', 'shaka.polyfill']);
goog.addDependency('../../../lib/polyfill/patchedmediakeys_webkit.js', ['shaka.polyfill.PatchedMediaKeysWebkit'], ['goog.asserts', 'shaka.log', 'shaka.media.DrmEngine', 'shaka.polyfill', 'shaka.util.BufferUtils', 'shaka.util.EventManager', 'shaka.util.FakeEvent', 'shaka.util.FakeEventTarget', 'shaka.util.PublicPromise', 'shaka.util.StringUtils', 'shaka.util.Timer', 'shaka.util.Uint8ArrayUtils']);
goog.addDependency('../../../lib/polyfill/pip_webkit.js', ['shaka.polyfill.PiPWebkit'], ['shaka.log', 'shaka.polyfill']);
goog.addDependency('../../../lib/polyfill/video_play_promise.js', ['shaka.polyfill.VideoPlayPromise'], ['shaka.log', 'shaka.polyfill']);
goog.addDependency('../../../lib/polyfill/videoplaybackquality.js', ['shaka.polyfill.VideoPlaybackQuality'], ['shaka.polyfill']);
goog.addDependency('../../../lib/polyfill/vttcue.js', ['shaka.polyfill.VTTCue'], ['shaka.log', 'shaka.polyfill']);
goog.addDependency('../../../lib/routing/node.js', ['shaka.routing.Node'], []);
goog.addDependency('../../../lib/routing/payload.js', ['shaka.routing.Payload'], []);
goog.addDependency('../../../lib/routing/walker.js', ['shaka.routing.Walker', 'shaka.routing.Walker.Implementation'], ['goog.asserts', 'shaka.routing.Node', 'shaka.routing.Payload', 'shaka.util.Destroyer', 'shaka.util.IDestroyable']);
...
goog.addDependency('../../../lib/text/mp4_vtt_parser.js', ['shaka.text.Mp4VttParser'], ['goog.asserts', 'shaka.log', 'shaka.text.Cue', 'shaka.text.TextEngine', 'shaka.text.VttTextParser', 'shaka.util.DataViewReader', 'shaka.util.Error', 'shaka.util.Functional', 'shaka.util.Iterables', 'shaka.util.Mp4Parser', 'shaka.util.StringUtils', 'shaka.util.TextParser']);
...
goog.addDependency('../../../lib/text/text_engine.js', ['shaka.text.TextEngine'], ['goog.asserts', 'shaka.text.Cue', 'shaka.util.BufferUtils', 'shaka.util.IDestroyable', 'shaka.util.MimeUtils']);
...
goog.addDependency('../../../lib/util/buffer_utils.js', ['shaka.util.BufferUtils'], ['shaka.util.Iterables']);
goog.addDependency('../../../lib/util/config_utils.js', ['shaka.util.ConfigUtils'], ['goog.asserts', 'shaka.log']);
goog.addDependency('../../../lib/util/data_view_reader.js', ['shaka.util.DataViewReader'], ['goog.asserts', 'shaka.util.BufferUtils', 'shaka.util.Error', 'shaka.util.StringUtils']);
...
goog.addDependency('../../../lib/util/ebml_parser.js', ['shaka.util.EbmlElement', 'shaka.util.EbmlParser'], ['goog.asserts', 'shaka.util.BufferUtils', 'shaka.util.DataViewReader', 'shaka.util.Error', 'shaka.util.Iterables']);
...
goog.addDependency('../../../lib/util/fairplay_utils.js', ['shaka.util.FairPlayUtils'], ['goog.Uri', 'shaka.util.BufferUtils']);
...
goog.addDependency('../../../lib/util/lazy.js', ['shaka.util.Lazy'], ['goog.asserts']);
...
goog.addDependency('../../../lib/util/mp4_parser.js', ['shaka.util.Mp4Parser'], ['goog.asserts', 'shaka.log', 'shaka.util.DataViewReader', 'shaka.util.Iterables']);
...
goog.addDependency('../../../lib/util/pssh.js', ['shaka.util.Pssh'], ['goog.asserts', 'shaka.log', 'shaka.util.Iterables', 'shaka.util.Mp4Parser', 'shaka.util.Uint8ArrayUtils']);
...
goog.addDependency('../../../lib/util/string_utils.js', ['shaka.util.StringUtils'], ['goog.asserts', 'shaka.log', 'shaka.util.BufferUtils', 'shaka.util.Error', 'shaka.util.Iterables', 'shaka.util.Lazy']);
...
goog.addDependency('../../../lib/util/uint8array_utils.js', ['shaka.util.Uint8ArrayUtils'], ['shaka.util.BufferUtils', 'shaka.util.Iterables', 'shaka.util.StringUtils']);
...
goog.addDependency('../../../ui/ad_counter.js', ['shaka.ui.AdCounter'], ['goog.asserts', 'shaka.ui.Element', 'shaka.ui.Localization', 'shaka.ui.Utils', 'shaka.util.Dom']);
goog.addDependency('../../../ui/ad_position.js', ['shaka.ui.AdPosition'], ['shaka.ui.Element', 'shaka.ui.Localization', 'shaka.util.Dom']);
goog.addDependency('../../../ui/audio_language_selection.js', ['shaka.ui.AudioLanguageSelection'], ['shaka.ui.Enums', 'shaka.ui.LanguageUtils', 'shaka.ui.Locales', 'shaka.ui.Localization', 'shaka.ui.OverflowMenu', 'shaka.ui.SettingsMenu']);
goog.addDependency('../../../ui/big_play_button.js', ['shaka.ui.BigPlayButton'], ['shaka.ui.PlayButton']);
...
goog.addDependency('../../../ui/presentation_time.js', ['shaka.ui.PresentationTimeTracker'], ['shaka.ui.Element', 'shaka.ui.Utils', 'shaka.util.Dom']);
...
goog.addDependency('../../../ui/settings_menu.js', ['shaka.ui.SettingsMenu'], ['shaka.ui.Element', 'shaka.ui.Enums', 'shaka.util.Dom']);
goog.addDependency('../../../ui/skip_ad_button.js', ['shaka.ui.SkipAdButton'], ['goog.asserts', 'shaka.ui.Element', 'shaka.ui.Localization', 'shaka.util.Dom']);
goog.addDependency('../../../ui/small_play_button.js', ['shaka.ui.SmallPlayButton'], ['shaka.ui.PlayButton']);
...
goog.addDependency('../../../ui/ui.js', ['shaka.ui.Overlay'], ['goog.asserts', 'shaka.Deprecate', 'shaka.polyfill', 'shaka.ui.Controls', 'shaka.ui.TextDisplayer', 'shaka.util.Platform']);
goog.addDependency('../../../ui/ui_utils.js', ['shaka.ui.Utils'], ['goog.asserts']);
goog.addDependency('../../../ui/volume_bar.js', ['shaka.ui.VolumeBar'], ['goog.asserts', 'shaka.ui.Constants', 'shaka.ui.Locales', 'shaka.ui.Localization', 'shaka.ui.RangeElement']);
