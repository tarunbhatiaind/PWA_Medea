...
shaka.media.SegmentReference = class {
   ...
   *   The amount of time, in seconds, that the segment's presentation
   *   timestamps are offset from the start of the Period. This value should
   *   equal the first presentation timestamp of the first frame/sample in the
   *   Period.  For example, for MP4 based streams, this value should equal the
   *   first segment's tfdt box's 'baseMediaDecodeTime' field (after it has been
   *   converted to seconds).
   */
  constructor(position,startTime,endTime,uris,startByte,endByte,initSegmentReference,presentationTimeOffset) {}
  /**
...
shaka.Player = class extends shaka.util.FakeEventTarget {
   ...
   * Get the uri to the asset that the player has loaded. If the player has not
   * loaded content, this will return <code>null</code>.
   * @deprecated Use <code>getAssetUri</code> instead.
   * @return {?string}
   */
  getManifestUri() {}
  /**
  ...
  getTextTracks() {}
  /**
   * Select a specific text track from the current period. <code>track</code>
   * should come from a call to <code>getTextTracks</code>. If the track is not
   ...
   * @deprecated Use <code>selectTextTrack</code> instead.
   */
  selectEmbeddedTextTrack() {}
  /**
   * @return {boolean} True if we are using any embedded text tracks present.
   * @deprecated Use <code>getTextTracks</code> and the <code>active</code>
   *   property instead.
   */
  usingEmbeddedTextTrack() {}
  /**
   * Select a specific variant track to play from the current period.
   * <code>track</code> should come from a call to
   * <code>getVariantTracks</code>. If <code>track</code> cannot be found in the
